#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed 15 Apr 23:15:47 BST 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /usr/bin/python3 scripts/analysis/compare_entropies_multi_layer.py --preset llama-3-8b --num-batches 50
  echo ---------------                                           
